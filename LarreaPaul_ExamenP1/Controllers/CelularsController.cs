...
namespace LarreaPaul_ExamenP1.Controllers
{
    public class CelularsController : Controller
    {
        ...
        public CelularsController(LarreaPaul_ExamenP1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,año,precio,IdCliente")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,año,precio,IdCliente")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
